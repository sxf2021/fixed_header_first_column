...
;(function ($, window, undefined) {
    ...
    function Plugin(el, options) {
        ...
        base.new_moveLeft = function (event) {
            ...
            if (event.offsetX > 0) {
                base.$el.each(function () {
                    var $this = $(this),
                        offset = $this.offset()
                    // base.$el.find('.tableFloatingFirstColOriginal').css("left", -offset.left + "px")
                    base.$el.find('.tableFloatingFirstColOriginal').css("left", (offset.left * -1) + "px")
                })
            }
            // $('.o_content .o_pivot').scroll(function(){
            //     var sl=this.scrollLeft,
            //         st=this.scrollTop,
            //         d=$(this).data('slt');
            //         console.log(sl, st);
            //         base.$el.find('.tableFloatingFirstColOriginal').css("left", sl + "px");
            // });
        };
        ...
        base.bind = function () {
            ...
            base.$el.on('mousewheel', base.new_moveLeft);
            base.$el.mouseenter(base.new_moveLeft);
    ...
    $.fn[name] = function (options) {
        return this.each(function () {
            ...
            // var o_pivot = $(".o_content").find("div .o_pivot");
            // console.log(o_pivot)
            // console.log(typeof o_pivot)
            // $(o_pivot).scroll(function () {//给table外面的div滚动事件绑定一个函数
            //     var left = $(o_pivot).scrollLeft();//获取滚动的距离
            //     console.log('o_pivot.scroll.left=', left)
            //     var trs = $(".o_pivot table tbody tr");//获取表格的所有tr
            ...
            /*$.data(this, 'plugin_' + name).updateOptions(options);
